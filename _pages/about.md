...
2. **On the Perception Bottleneck of VLMs for Chart Understanding.**  
   **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *arXiv*, 2025. (First author; code: Vision4Chart)
3. **On the Universal Truthfulness Hyperplane Inside LLMs.**  
   **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (First author; code: Universal_Truthfulness_Hyperplane)
...
My research spans natural language processing and machine learning, with a focus on LLM reasoning, reinforcement learning, vision-language models, LLM truthfulness, and interpretability.
